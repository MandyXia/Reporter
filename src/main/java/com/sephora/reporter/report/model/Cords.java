...
public class Cords {
	...
	public static Cord VIP_PROVISION = new Cord(2, "VIP provision", Cord.FROM_ALLOCATE, "A1");
	...
	public static Cord DIRECT_MARGIN = new Cord(5, "Direct Margin", Cord.FROM_FORMULA, "F2");
	public static Cord OTHER_COGS = new Cord(6, "Other COGS", Cord.FROM_FORMULA, "F3");
	public static Cord TOTAL_COGS = new Cord(7, "Total COGS", Cord.FROM_SAP, "COST OF GOODS SALES");
	public static Cord FRONT_MARGIN = new Cord(8, "Front Margin", Cord.FROM_FORMULA, "F4");
	public static Cord SUPPLIES_DISCOUNTS = new Cord(9, "Suppliers discounts", 6, "");
	public static Cord ANIMATION_REVENUES = new Cord(10, "Animation revenues", Cord.FROM_ALLOCATE, "A2");
	public static Cord GROSS_MARGIN = new Cord(11, "Gross margin", Cord.FROM_FORMULA, "F5");
	public static Cord STOCK_DEPRECIATION = new Cord(12, "Stock depreciation", Cord.FROM_ALLOCATE, "A3");
	...
	public static Cord GROSS_PROFIT = new Cord(15, "Gross profit", Cord.FROM_FORMULA, "F6");
	...
	public static Cord DISPLAY = new Cord(19, "Display", Cord.FROM_ALLOCATE, "A4");
	...
	public static Cord INSURANCE_OTHER = new Cord(28, "Insurance & other", Cord.FROM_ALLOCATE, "A5");
	public static Cord CREDIT_CARD_FEES = new Cord(29, "Credit card fees", Cord.FROM_SAP, "BANK COMMISSIONS");
	public static Cord TAXES = new Cord(30, "Taxes", Cord.FROM_ALLOCATE, "A6");
	public static Cord OTHER_SHOP_EXPENSES = new Cord(31, "Other shop expenses", Cord.FROM_FORMULA, "F7");
	public static Cord SHOP_PROFIT = new Cord(33, "Shop Profit", Cord.FROM_FORMULA, "F8");
